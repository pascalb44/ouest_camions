...
const Legal = () => {
    return (
        <div>
            <h1 className='h1Legal'>Mentions légales</h1>
            <div className='blocLegal'>
                <h2 className='h2Legal'> Identité de l'Entreprise</h2>
                     Raison sociale : Ouest Camions
                <h2 className='h2Legal'> Hébergeur du Site</h2>
                    <p>OVH</p>
                    <p>140 quai du Sartel</p>
                    <p>59100 Roubaix</p>
                    <p>France</p>
                    <h2 className='h2Legal'> Conditions Générales de Vente</h2>
                    <div className='articleLegal'>Article 1 : Objet</div>
                    ...
                    <div className='articleLegal'>Article 2 : Acceptation des CGV</div>
                    ...
                    <div className='articleLegal'>Article 3 : Réservation</div>
                    ...
                    <div className='articleLegal'>Article 4 : Tarifs</div>
                    ...
                    <div className='articleLegal'> Article 5 : Modalités de paiement</div>

                    5.1 Paiement<br />
                    Le paiement s'effectue en ligne lors de la réservation. Les moyens de paiement acceptés sont : [carte bancaire, PayPal, etc.].

                    <div className='articleLegal'> Article 6 : Durée de la location</div>
                    ...
                    <div className='articleLegal'>Article 7 : Annulation</div>
                    ...
                    <div className='articleLegal'>Article 8 : Prise en charge et restitution du camion</div>
                    8.1 Prise en charge
                    ...
                    <div className='articleLegal'>Article 9 : Assurance</div>
                    ...
                    <div className='articleLegal'>Article 10 : Responsabilité</div>
                    ...
                    <div className='articleLegal'>Article 11 : Protection des données personnelles</div>
                    ...
                    <div className='articleLegal'>Article 12 : Loi applicable et litiges</div>
